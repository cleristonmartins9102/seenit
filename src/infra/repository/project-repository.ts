...
import { storage } from '../../application/mocks/create-user-model-mock'
...
import { type CreateProjectModel, type ProjectModel } from 'models/project-model'
...
export class ProjectRepository implements CreateProject, UpdateProjects, LoadProjects, DeleteProjects {
  ...
  update (updateProjectModel: UpdateUserModel): ProjectModel | null | boolean {
